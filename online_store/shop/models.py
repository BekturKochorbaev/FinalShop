...
class UserProfile(AbstractUser):
    age = models.PositiveSmallIntegerField(null=True, blank=True, validators=[MinValueValidator(15), MaxValueValidator(100)])
...
class ProductPhoto(models.Model):
    product = models.ForeignKey(Product, related_name='products_photo', on_delete=models.CASCADE)
...
class Review(models.Model):
    ...
    prent_view = models.ForeignKey('self', related_name='reviews', null=True, blank=True, on_delete=models.CASCADE)
